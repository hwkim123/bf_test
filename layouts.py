...
main_page_layout = html.Div(id='main-page', children=[
    ...
    html.Div(
        ...
        children=[
            html.Div([html.Button("Set Batfish Host", id="set-batfish-host-button",
                                  className="main_page_button")],
                     className="main_page_button_div"),
            html.Div([html.Button("Create/Delete Network", id="create-network-button",
                                  className="main_page_button")],
                     className="main_page_button_div"),
            html.Div([html.Button("Create/Delete Snapshot", id="create-snapshot-button",
                                  className="main_page_button")],
                     className="main_page_button_div"),
            ...
            html.Div([html.Button("Ask a Question", id="ask-question-button",
                                  className="main_page_button")],
                     className="main_page_button_div"),

            # 콜백용 hidden buttons (ReferenceError 방지)
            html.Button(id='select-network-button', style={'display': 'none'}),
            html.Button(id='create_network_submit_button', style={'display': 'none'}),
            ...
            html.Div(
                ...
                children=[
                        ...
                        dbc.Card(
                            ...
                            children=[dbc.CardBody(children=[
                                dbc.Form([
                                    ...
                                    dbc.Button("Submit", id="set_batfish_host_submit_button",
                    ...
                    dbc.Collapse(
                        dbc.Card(className='main_page_card', children=[dbc.CardBody(children=[])]),
                ...
                children=[
                    ...
                    dbc.ModalBody(
                        children=[
                            ...
                            html.Div([], id='select-network-snapshot-modal', style=dict(flex="1")),
                            html.Div([], id='delete-snapshot-dropdown-div', style=dict(flex="1")),
                            html.Div([
                                dcc.Upload(className='Snapshot_Upload', id='device-configs-upload-data',
                                           children=html.Div(className='inside_drag_and_drop', children=[
                                               html.P(className="upload_p", children=[html.H3("Device Configurations"),
                                                                                      'Drag and Drop or ',
                                                                                      html.A('Select Files')])
                                           ]), multiple=True),
                                dcc.Upload(className='Snapshot_Upload', id='host-configs-upload-data',
                                           children=html.Div(className='inside_drag_and_drop', children=[
                                               html.P(className="upload_p", children=[html.H3("Host Configurations"),
                                                                                      'Drag and Drop or ',
                                                                                      html.A('Select Files')])
                                           ]), multiple=True),
                                dcc.Upload(className='Snapshot_Upload', id='iptables-configs-upload-data',
                                           children=html.Div(className='inside_drag_and_drop', children=[
                                               html.P(className="upload_p", children=[html.H3("IP Table Configurations"),
                                                                                      'Drag and Drop or ',
                                                                                      html.A('Select Files')])
                                           ]), multiple=True),
                                dcc.Upload(className='Snapshot_Upload', id='aws-configs-upload-data',
                                           children=html.Div(className='inside_drag_and_drop', children=[
                                               html.P(className="upload_p", children=[html.H3("AWS Configurations"),
                                                                                      'Drag and Drop or ',
                                                                                      html.A('Select Files')])
                                           ]), multiple=True),
                                dcc.Upload(className='Snapshot_Upload', id='misc-configs-upload-data',
                                           children=html.Div(className='inside_drag_and_drop', children=[
                                               html.P(className="upload_p", children=[html.H3("Miscellaneous Configurations"),
                                                                                      'Drag and Drop or ',
                                                                                      html.A('Select Files')])
                                           ]), multiple=True),
                    ...
                    dbc.ModalFooter(children=[
                        html.A("How to format your configurations!",
                               href="https://pybatfish.readthedocs.io/en/latest/formats.html"),
                        dbc.FormGroup([dbc.Input(id="create-snapshot-name", value="", placeholder="New Snapshot Name"),
                                       dbc.FormFeedback("Please enter a name for the snapshot", valid=False)],
                                      className="mr-3"),
                        dbc.Button("Submit", id="create_snapshot_submit_button",
                                   color="dark", outline=True, style=dict(height="25px")),
                    ]),
                ]
            )
        ],
                ...
                children=[
                    ...
                    dbc.ModalBody(children=[
                        html.Div([dcc.Dropdown(
                            ...
                            options=[],
                            value=None
                        )], id='ask-a-question-dropdown-modal', style=dict(position="relative", height="100px", margin_top="10px")),
        ...
        children=[
            dbc.Modal(
                ...
                children=[
                    ...
                    dbc.ModalBody(children=[
                        html.Div([dcc.Textarea(id='change_configuration_textarea', value='',
        ...
        children=[
            dbc.Modal(
                ...
                children=[
                    ...
                    dbc.ModalBody(children=[
                        dbc.InputGroup([dbc.Select(id="acl_choose_node", options='', value='')]),
                        html.Div([dcc.Textarea(id='acl_configuration_textarea', value='',
                                               style={'width': '100%', 'height': '500px'})]),
                    ]),
                ]
            )
