...
main_page_layout = html.Div(id='main-page', children=[
    ...
    html.Div(
        ...
        children=[
            ...
            # Hidden elements for missing callback inputs
            html.Button(id='select-snapshot-button', style={'display': 'none'}),
            html.Div(id='cytoscape', style={'display': 'none'}),
            html.Div(id='create-network-form', style={'display': 'none'}),
            html.Button(id='modal-select-network-button', style={'display': 'none'}),
        ],
    ),
    html.Div(
                ...
                children=[
                        ...
                        children=[
                            ...
                            html.Div([
                                dcc.Upload(className='Snapshot_Upload', id='device-configs-upload-data',
                                           children=html.Div(className='inside_drag_and_drop',
                                                             children=[html.P(className="upload_p",
                                                                              children=[html.H3("Device Configurations"),
                                                                                        'Drag and Drop or ',
                                                                                        html.A('Select Files')])]),
                                           multiple=True),
                                dcc.Upload(className='Snapshot_Upload', id='host-configs-upload-data',
                                           children=html.Div(className='inside_drag_and_drop',
                                                             children=[html.P(className="upload_p",
                                                                              children=[html.H3("Host Configurations"),
                                                                                        'Drag and Drop or ',
                                                                                        html.A('Select Files')])]),
                                           multiple=True),
                                dcc.Upload(className='Snapshot_Upload', id='iptables-configs-upload-data',
                                           children=html.Div(className='inside_drag_and_drop',
                                                             children=[html.P(className="upload_p",
                                                                              children=[html.H3("IP Table Configurations"),
                                                                                        'Drag and Drop or ',
                                                                                        html.A('Select Files')])]),
                                           multiple=True),
                                dcc.Upload(className='Snapshot_Upload', id='aws-configs-upload-data',
                                           children=html.Div(className='inside_drag_and_drop',
                                                             children=[html.P(className="upload_p",
                                                                              children=[html.H3("AWS Configurations"),
                                                                                        'Drag and Drop or ',
                                                                                        html.A('Select Files')])]),
                                           multiple=True),
                                dcc.Upload(className='Snapshot_Upload', id='misc-configs-upload-data',
                                           children=html.Div(className='inside_drag_and_drop',
                                                             children=[html.P(className="upload_p",
                                                                              children=[html.H3("Miscellaneous Configurations"),
                                                                                        'Drag and Drop or ',
                                                                                        html.A('Select Files')])]),
                                           multiple=True),
                    ...
                    dbc.ModalFooter(
                        children=[
                            ...
                            dbc.FormGroup([
                                dbc.Input(id="create-snapshot-name", value="", placeholder="New Snapshot Name"),
                                dbc.FormFeedback("Please enter a name for the snapshot", valid=False),
                            ], className="mr-3"),
                            dbc.Button("Submit", id="create_snapshot_submit_button", color="dark", outline=True,
                                       style=dict(height="25px")),
                        ]
                    ),
                ]
        ...
        children=[
            dbc.Modal(
                ...
                children=[
                    ...
                    dbc.ModalBody(children=[
                        dbc.InputGroup([
                            dbc.Select(id="acl_choose_node", options='', value=''),
                        ]),
                        html.Div([
                            dcc.Textarea(
